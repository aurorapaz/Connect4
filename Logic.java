...
public class Logic {
  ...
  //Introduce Ficha en la Columna Elegida comprobando cual es la posicion libre más baja de la columna
  public static void introducirFicha(char jugador,char[][] tablero,int columnaEscogida){
	...
	public static boolean ganador(char jugador, char[][] tablero){
		...
		//Comprueba si 4 fichas en diagonal ascendente hacia la derecha (equivale a diagonal descendente hacia la izquierda)
		...
		//Comprueba si 4 fichas en diagonal descendente hacia la derecha (equivale a diagonal ascendente hacia la izquierda)
		for(int fila = 0; fila < 3; fila++){
			for(int columna = 0; columna < 4; columna++){
				if (tablero[fila][columna] == jugador   && 
					tablero[fila+1][columna+1] == jugador &&
